        ...
        <div className={`content${minimized ? 'minimized' : ''}`}>
          ...
          <div className="feedback-container">
            {filteredFeedback.map((feedback, index) => (
              <Link to={`/FeedBack/FeedbackAnswerList/FeedbackUserList/${feedback.id}`} key={index} className="feedback-link">
...
export default FeedbackAnswerList;
